  ...
  try {
    ...
    const updatedEmployee = await prisma.employee.update({
      ...
      data: {
        ...
        transportAllowance: body.transportAllowance !== undefined ? Number(body.transportAllowance) : employee.transportAllowance,
        positionAllowance: body.positionAllowance !== undefined ? Number(body.positionAllowance) : employee.positionAllowance,
        phoneAllowance: body.phoneAllowance !== undefined ? Number(body.phoneAllowance) : employee.phoneAllowance,
        otherAllowance: body.otherAllowance !== undefined ? Number(body.otherAllowance) : employee.otherAllowance,
