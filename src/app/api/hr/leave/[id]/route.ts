...
export async function PUT(
  ...
  try {
    ...
    const { id: _id, createdAt: _ca, employee: _employee, ...updateData } = body;
    ...
    const updatedRecord = await prisma.leaveRequest.update({
      where: { id: params.id },
      data: updateData,
    });
...
export async function DELETE(
  ...
  try {
    ...
    const deletedRecord = await prisma.leaveRequest.update({
      where: { id: params.id },
