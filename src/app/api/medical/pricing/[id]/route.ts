...
export async function GET(
  ...
  try {
    const record = await prisma.medicalPricing.findUnique({
      where: { id: params.id },
    });
...
export async function PUT(
  ...
  try {
    ...
    const updatedRecord = await prisma.medicalPricing.update({
      where: { id: params.id },
      data: updateData,
    });
...
export async function DELETE(
  ...
  try {
    ...
    const deletedRecord = await prisma.medicalPricing.update({
      where: { id: params.id },
