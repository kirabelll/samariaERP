    ...
    const customerData = agreements
      ...
      .map(agr => {
        ...
        return {
          ...
          licenseNo: agr.customer!.licenseNo,
          licenseExpiry: agr.customer!.licenseExpiry,
          licenseType: agr.customer!.licenseType,
          medicalApproved: agr.customer!.medicalApproved,
          // Agreement info
          agreementId: agr.id,
