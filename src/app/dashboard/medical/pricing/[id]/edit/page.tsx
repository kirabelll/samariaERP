...
export default function MedicalPricingEditEditPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/medical/pricing/${recordId}`);
    } catch (err) {
      setError(err instanceof Error ? err.message : 'An error occurred');
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {["itemId","manufacturerPrice","freight","insurance","customs","inlandTransport","bankCost","warehouseCost","handlingCost","wastageAllowance","otherCosts","marginPercent","recommendedPrice","approvedPrice","effectiveDate"].map((field) => (
                  <div key={field}>
