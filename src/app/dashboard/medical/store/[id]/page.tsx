...
export default function MedicalBatchDetailDetailPage() {
  ...
  const handleEdit = () => {
    router.push(`/dashboard/medical/store/${recordId}/edit`);
  };
        ...
        <CardBody className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {["batchNo","itemId","expiryDate","quantity","costPrice","warehouse","status","receivedDate"].map((field) => (
                <div key={field}>
