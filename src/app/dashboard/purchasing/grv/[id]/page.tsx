...
export default function GoodsReceiveDetailDetailPage() {
  ...
  const handleEdit = () => {
    router.push(`/dashboard/purchasing/grv/${recordId}/edit`);
  };
        ...
        <CardBody className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {["grvNo","supplierId","purchaseOrderId","totalAmount","receivedBy","receivedDate","status"].map((field) => (
                <div key={field}>
