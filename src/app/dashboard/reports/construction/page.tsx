...
const reports: ReportCard[] = [
  {
    id: 'dispatch',
    title: 'Aggregate Dispatch Report',
    description: 'Dispatch summary by period',
    icon: '📦',
  },
  {
    id: 'shortage',
    title: 'Shortage Report',
    description: 'All shortages with totals',
    icon: '⚠️',
  },
  {
    id: 'transport',
    title: 'Transport Payment Summary',
    description: 'Payments by transporter',
    icon: '🚚',
  },
  {
    id: 'commission',
    title: 'Association Commission Report',
    description: 'Commission details by association',
    icon: '💰',
  },
  {
    id: 'cement',
    title: 'Cement Lifting Report',
    description: 'Lifting details by factory',
    icon: '🏭',
  },
  {
    id: 'penalty',
    title: 'Cement Penalty Report',
    description: 'Penalties and adjustments',
    icon: '📊',
  },
];
...
export default function ConstructionReportsPage() {
  ...
  const fetchReportData = async (reportId: string) => {
    ...
    try {
      ...
      const res = await fetch(`/api/reports/construction?${params}`);
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/reports/construction/export?${params}`);
