...
export default function DeliveryDetailDetailPage() {
  ...
  const handleEdit = () => {
    router.push(`/dashboard/sales/deliveries/${recordId}/edit`);
  };
        ...
        <CardBody className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {["deliveryNo","customerId","salesOrderId","division","driverName","truckPlateNo","deliveredTo","deliveryDate","status"].map((field) => (
                <div key={field}>
